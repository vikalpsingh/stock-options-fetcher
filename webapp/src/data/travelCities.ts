...
export const travelCities: TravelCity[] = [
  { slug: "ujjain", cityName: "Ujjain", state: "Madhya Pradesh", country: "India", aliases: ["ujain", "mahakal"], isKumbhCity: true, nearestAirportCode: "IDR", railwayStationCodes: ["UJN"], redbusCityId: todo("redbus", "ujjain"), bookingSearchText: "Ujjain, Madhya Pradesh, India", irctcSearchText: "Ujjain Junction", priority: 1 },
