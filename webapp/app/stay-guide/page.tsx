...
import { HotelBookingCards } from "@/src/components/packages/HotelBookingCards";
...
export default function StayPage() {
  ...
  return (
    <main>
      ...
      <section className="pattern-mandala bg-cream px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl"><SectionTitle eyebrow="Booking options" title="Book Stay for Ujjain Kumbh 2028" description="Compare external hotel listings by base city. Final availability, price and cancellation terms are provided by the booking partner." /><div className="mt-10"><HotelBookingCards /></div><div className="mt-8 rounded-3xl bg-maroon p-6 text-white sm:flex sm:items-center sm:justify-between sm:gap-6 sm:p-8"><div><p className="text-sm font-bold text-gold">Need stay + transport + darshan support?</p><h3 className="mt-2 font-serif text-2xl text-white">Request a complete package quote.</h3></div><Button asChild className="mt-5 sm:mt-0"><Link href="/ujjain-kumbh-2028/packages">Explore Ujjain Packages<ArrowRight className="h-4 w-4" /></Link></Button></div></div>
      </section>
